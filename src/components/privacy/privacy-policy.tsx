  ...
  return (
    <main className={styles.container}>
      <header className={styles.header}>
        ...
        <p className={styles.lastUpdated}>Last updated: November 2026</p>
      </header>

      <section className={styles.section}>
        <h2>1. Introduction</h2>
        <p>
          This privacy policy explains how Crafity ("we", "us", "our") collects,
          uses, and protects your personal data when you visit our website and
          use our services. We are committed to protecting your privacy and
      ...
      <section className={styles.section}>
        ...
        <p>
          <strong>Purpose:</strong> To respond to your inquiry and provide
          information about our services.
        </p>
        <p>
          <strong>Legal basis:</strong> Legitimate interest (Article 6(1)(f)
          GDPR) - we need this information to respond to your request.
        </p>
        <p>
          <strong>Retention period:</strong> We retain emails from our contact
          form indefinitely unless you request deletion. This allows us to
          maintain a history of our business communications. You can request
          deletion of your data at any time.
        </p>
        <p>
          <strong>Processing:</strong> When you submit the form, your
          information is sent via email to our business email address hosted by
          Google Workspace. No data is stored in a database on our website.
        </p>
        ...
        <p>
          <strong>Data collected by Google Analytics may include:</strong>
        </p>
        <ul>
          <li>Pages visited</li>
        ...
        <p>
          <strong>Legal basis:</strong> Consent (Article 6(1)(a) GDPR) - we only
          activate Google Analytics after you accept cookies via our cookie
          banner.
        </p>
        <p>
          <strong>Your choice:</strong> You can decline Google Analytics
          tracking via our cookie banner. This will not affect your ability to
          use our website.
        </p>
        <p>
          <strong>Data sharing:</strong> Google Analytics data is processed by
          Google LLC. While Google may process data outside the EU, they provide
          appropriate safeguards through their EU-US Data Privacy Framework
        ...
        <p>
          <strong>Purpose:</strong> Website security, performance monitoring,
          and troubleshooting.
        </p>
        <p>
          <strong>Legal basis:</strong> Legitimate interest (Article 6(1)(f)
          GDPR) - necessary for the operation and security of our website.
        </p>
        <p>
          <strong>Retention period:</strong> Server logs are retained according
          to Vercel's standard retention policies.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <ul>
          ...
          <li>
            <strong>Safeguards:</strong> Standard Contractual Clauses, EU-US
        ...
        <ul>
          <li>
            <strong>Purpose:</strong> Website analytics (optional, requires
            consent)
          </li>
          <li>
            <strong>Location:</strong> Data may be processed in multiple
        ...
        <ul>
          ...
          <li>
            <strong>Location:</strong> Our website is hosted in Frankfurt,
            Germany (EU)
          </li>
          <li>
            <strong>Safeguards:</strong> Vercel complies with GDPR requirements
          </li>
        </ul>
      </section>
      ...
      <section className={styles.section}>
        <h2>4. Cookies</h2>
        <p>We use cookies only with your consent via our cookie banner.</p>
        ...
        <ul>
          <li>
            <strong>Analytics cookies (Google Analytics):</strong> Only placed
            after you consent via the cookie banner
          </li>
          <li>
        ...
        <p>
          ...
          cookie settings link in our footer or clearing your browser cookies.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <ul>
          ...
          <li>
            <strong>Right to restriction:</strong> You can ask us to limit how
            we use your data
          </li>
          <li>
      ...
      <section className={styles.section}>
        ...
        <ul>
          ...
          <li>Hosting with a reputable EU-based data center (Frankfurt)</li>
      ...
      <section className={styles.section}>
        ...
        <ul>
          <li>
            <strong>Contact form emails:</strong> Retained indefinitely unless
            you request deletion
          </li>
          <li>
            <strong>Google Analytics data:</strong> Retained according to Google
            Analytics settings (typically 14-26 months)
          </li>
          <li>
      ...
      <section className={styles.section}>
        ...
        <p>
          Our services are not directed at children under 16 years of age. We do
