      ...
      <Container size="comfortable">
        <Stack gap={8}>
          ...
          <LeftAccentCard
            children={
              <p>
                ...
                expensive, time-consuming operations. The business wanted to
                move faster, but the platform architecture wouldn't let them.
              </p>
            }
          ...
          <LeftAccentCard
            children={
              <p>
                With thousands of professional tools across multiple languages
                and markets, customers needed instant, intelligent search. The
          ...
          <LeftAccentCard
            children={
              <p>
                ...
                build the new platform <em>and</em> build their team's
                capability to own it.
              </p>
            }
            accentColor="primary"
