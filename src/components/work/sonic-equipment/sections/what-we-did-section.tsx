    ...
    <Container size="comfortable">
      <Stack gap={16}>
          ...
          description={
            <>
              <p>
                ...
                approach meant we could iterate quickly while keeping 65
              ...
              <p>
                ...
                Next.js, but don't couple to any specific platform. This let us
                deliver value immediately while preparing for the bigger
                architectural shift.
              </p>
            </>
          }
        ...
        <ServiceCard
          description={
            <>
              <p>
                ...
                Sonic server-side rendering for instant page loads, edge caching
                for global performance, and most importantly: fast, independent
                deployment.
              </p>
              <p>
          ...
          index={2}
          title="Move to Modern Infrastructure"
        />
